...
### B74. The section header hangs below the rule as a tab in the rule's own ink (issue #111; supersedes B47/B54's "label above the rule" and B54's band budget; keeps B47's full-width rule and content-sizing, and B37's law)
