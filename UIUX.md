...
13px/600 (B74, issue #111; supersedes B47/B54's label-*above*-the-rule, closing
...
The label term (`+ 16.9 + 10`) is gone from the budget: since B74 the header
...
**Superseded by B74 (issue #111):** the label no longer sits above the rule, so
